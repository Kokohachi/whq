...
function App() {
  ...
  const lastAnswerStyle = lastAnswerCorrect === null ? { background: "var(--color-background-secondary)", color: "var(--color-text-secondary)" } : lastAnswerCorrect ? { background: "var(--color-background-success)", color: "var(--color-text-success)" } : { background: "var(--color-background-danger)", color: "var(--color-text-danger)" };
